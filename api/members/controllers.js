...
const login = async (req, res) => {
  try {
    ...
    res.json({ token, user: { id: member.member_id, username: member.username, name: member.name, surname: member.surname , email: member.email , balance : member.balance , bio: member.bio } });
  } catch (err) {
